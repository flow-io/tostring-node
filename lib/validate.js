...
(function() {
	...
	*	Validates the stream isUndefined option.
	*
	* @private
	* @param {String} value - isUndefined option
	* @return {Null|TypeError} null if valid or TypeError if invalid
	*/
	function isUndefined( value ) {
		if ( typeof value !== 'string' ) {
			return new TypeError( 'Stream()::invalid input argument. isUndefined must be a string.' );
		}
		return null;
